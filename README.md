...
After installation, the client will scan for nearby servers.  Once a server is connetected, it will need to be calibrated for the water holding tank (the scale icon in the upper right-hand corner).
